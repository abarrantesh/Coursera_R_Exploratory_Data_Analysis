  ...
  library("data.table")
  power <- read.table("Q:/Universidad, Lean Manufacturing, Six Sigma, DOE/Coursera/1 -Data Science Specialization/4. Exploratory Data Analysis/Assigment/Week1/household_power_consumption.txt"
                      , skip=1,sep=";")
